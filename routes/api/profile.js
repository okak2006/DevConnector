...
router.post('/', [auth, [
    ...
    try {
        ...
        try {
            ...
            //Update
            if(profile){
                //We set this to variable because we want to return updated data. useFindAndModify to fix deprecation warning
            ...
            // Create New Profile - code only reaches here if !profile
...
router.get('/user/:user_id', async (req, res) => {
    try{
        ...
        console.error(err.message);
        // We want to be more specific. If we supply an invalid object id
...
router.put('/experience', [auth, [
    ...
    try {
        ...
        // push adds to end, unshift adds to beginning so most recent comes first. experience is arr of objects
...
router.get('/github/:username', async (req,res) => {
    try {
        ...
        request(options, (error, response, body) => {
            ...
            //without parsing body is just regular string with escaped characters
